...
public class BearerTokenCreatorTest {
  ...
  public void setUp() throws Exception {
    tokenCreator = new BearerTokenCreator(repository, tokenGenerator, tokenSecurity, authorizationRepository, clock, refreshTokenGenerator);
  }
  ...
  public void createByProvidedAuthCode() throws Exception {
    ...
    Token actualToken = tokenCreator.create(providedAuthorizationCode, duration);
  ...
  public void createByProvidedRefreshToken() throws Exception {
    ...
    Token actualToken = tokenCreator.create(providedRefreshToken, duration);
